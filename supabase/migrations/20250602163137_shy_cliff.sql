/*
  # Subscription Plans and Usage Tracking Schema
  
  1. New Tables
    - subscription_plans: Defines available subscription tiers and usage limits
    - user_subscriptions: Tracks user plan memberships
  ...
  3. Functions
    - get_user_plan_and_usage: Retrieves usage stats and remaining time
*/
