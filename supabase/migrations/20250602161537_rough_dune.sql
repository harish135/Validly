/*
  ...
  1. New Tables
    ...
    - `user_subscriptions`: Tracks a user's current subscription plan
    - `feature_usage_tracking`: Logs each time a user consumes a feature, and for how long
    - `feature_usage`: Aggregates total usage per feature per user
  ...
  3. Changes
    - Add functions to check and track usage
*/
...
CREATE TABLE IF NOT EXISTS public.subscription_plans (
    ...
    daily_time_allowance_minutes integer COMMENT 'Total minutes of feature usage allowed per day. NULL for unlimited.',
    description text,
